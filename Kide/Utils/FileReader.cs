/// https://github.com/AvaloniaUI/AvaloniaEdit/blob/master/src/AvaloniaEdit/Utils/FileReader.cs
...
namespace Kide.Utils
{
    ...
    internal static class FileReader
    {
        ...
        {
            if (encoding is UTF8Encoding) return UTF8NoBOM;
            return encoding;
            ...
            switch (state)
            {
                case ASCII:
                    ...
                    return new StreamReader(fs,
                        IsAsciiCompatible(defaultEncoding) ? RemoveBom(defaultEncoding) : Encoding.UTF8);
                case Error:
