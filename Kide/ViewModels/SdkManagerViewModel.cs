    ...
    public class SdkManagerViewModel : ViewModelBase
    {
        public Dictionary<string, PlatformSdk> DownloadLinks => new()
        {
            ...
            },*/
            {
                ...
                {
                    X64 =
                        "https://mirror.freemirror.org/pub/fpc/dist/3.2.2/i386-win32/fpc-3.2.2.i386-win32.cross.x86_64-win64.exe",
            ...
            },
            {
                "Linux", new PlatformSdk
                {
                    ...
                    X86 =
                        "https://mirror.freemirror.org/pub/fpc/dist/3.2.2/i386-linux/fpc-3.2.2.i386-linux.cross.x86_64-linux.tar"
                }
            }
        };
    }
